  ...
  return (
    <div className="flex max-w-[1400] mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-20 mt-20 background-gradient">
        <a
          href="https://api.whatsapp.com/send/?phone=5565999103791&text=Ol%C3%A1!%20Estou%20interessado(a)%20em%construir%20um%site!"
          target="_blank"
          rel="noreferrer"
          className="border border-gray-700 rounded-lg py-4 px-6 text-gray-400 text-s=mm mb-5 transition duration-300 ease-in-out"
        >
        ...
        <Link
          ...
          href="https://api.whatsapp.com/send/?phone=5565999103791&text=Ol%C3%A1!%20Estou%20interessado(a)%20em20%construir%20um%20site!"
        >
        ...
        <div className="flex w-full flex-col sm:mt-10 mt-6">
          <h1 className="mx-auto max-w-7xl font-display text-4xl font-bold pb-12 tracking-normal text-gray-300 md:text-6xl">
          ...
          <div className="flex flex-col space-y-10 mt-6 mb-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:space-x-6 sm:px-8">
              <div className="col-span-1 sm:p-12 p-2">
                <h3 className="mb-1 font-medium text-4xl text-start p-6">
                  A Technology in Aeternum
                </h3>
                <div className="p-7">
                  <p className="sm:text-2xl text-xl py-2 text-left">
                  ...
                  <Link
                    className="bg-green-600 block rounded-xl text-white lg:text-2xl uppercase px-10 sm:w-[35vw] lg:w-[30vw] py-5 sm:mt-12 mt-4 hover:bg-green-700 transition"
                    href="https://api.whatsapp.com/send/?phone=5565999103791&text=Ol%C3%A1!%20Estou%20interessado(a)%20em20%construir%20um%20site!"
                  >
                    Comece seu site hoje
                  </Link>
              ...
              <div className="col-span-1 sm:mt-0 mt-8 sm:p-12 p-2">
                <div className="image-container">
                  ...
                  <Image
                    ...
                    className="w-full block object-cover lg:h-[690px] rounded-2xl sm:mt-0 mt-2"
                  />
                </div>
              </div>
            </div>
        ...
        <div className="flex w-full flex-col sm:mt-10 mt-6">
          <h1 className="mx-auto max-w-7xl font-display text-5xl font-bold pb-12 tracking-normal text-gray-300 sm:text-7xl">
          ...
          <div className="grid grid-cols-1 mx-7 md:grid-cols-2 gap-6 sm:p-12">
            <figure className="border border-green-900 rounded-xl sm:p-12 p-2">
              ...
              <div className="pt-6 t space-y-4">
                <h1 className="sm:text-3xl font-medium text-2xl pt-6">
                  Sites Otimizados
                </h1>
            ...
            <div className="flex flex-col lg:items-start justify-around p-8">
              <div className="flex flex-col md:flex-row py-8 items-center justify-center md:justify-between">
                ...
                <div className="flex flex-col items-center lg:items-start justify-center p-4">
                  <span className="md:text-3xl">Chamar no WhatsApp</span>
                </div>
              </div>
              <div className="flex flex-col md:flex-row py-8 items-center justify-center md:justify-between">
                <Phone size={96} className="bg-green-500 rounded py-4 min-w-[96px]"/>
                <div className="flex flex-col items-center lg:items-start justify-center p-4">
                  <span className="text-sm md:text-2xl lg:text-start">Ligue já</span>
                  <span className="text-sm md:text-3xl">(65) 99910-3791</span>
                </div>
              </div>
              <div className="flex flex-col md:flex-row py-8 items-center justify-center md:justify-between">
